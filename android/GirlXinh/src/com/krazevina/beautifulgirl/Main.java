...
public class Main extends Activity implements OnClickListener, OnKeyListener
{
    ...
    TextView btnmenu,btnmenu2,btnmenu3;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        llbtn_hot = (LinearLayout)findViewById(R.id.llbtn_hot);
        llbtn_top = (LinearLayout)findViewById(R.id.llbtn_top);
        llbtn_moi = (LinearLayout)findViewById(R.id.llbtn_moi);
        btnmenu = (TextView)findViewById(R.id.btn_menu);
        btnmenu2 = (TextView)findViewById(R.id.btn_menu2);
        btnmenu3 = (TextView)findViewById(R.id.btn_menu3);
        ...
        try {
			...
			Log.d("versionCode",""+versionNumber);
...
//        		overridePendingTransition(R.anim.downin,0);
    ...
    public void updateMenu()
    {
    	if(stateMenu){
    		...
    		llbtn_moi.setVisibility(View.VISIBLE);
    		llbtn_hot.setVisibility(View.VISIBLE);
    		llbtn_top.setVisibility(View.VISIBLE);
    		llbtn_fav.setVisibility(View.VISIBLE);
    		llbtn_down.setVisibility(View.VISIBLE);
    		llbtn_up.setVisibility(View.VISIBLE);
    		llbtn_id.setVisibility(View.VISIBLE);
    		llbtn_new.setVisibility(View.VISIBLE);
    		llbtn_rand.setVisibility(View.VISIBLE);
    		...
    		llbtn_moi.setVisibility(View.GONE);
    		llbtn_hot.setVisibility(View.GONE);
    		llbtn_top.setVisibility(View.GONE);
    		llbtn_fav.setVisibility(View.GONE);
    		llbtn_down.setVisibility(View.GONE);
    		llbtn_up.setVisibility(View.GONE);
    		llbtn_id.setVisibility(View.GONE);
    		llbtn_new.setVisibility(View.GONE);
    		llbtn_rand.setVisibility(View.GONE);
	...
	public void revertButton()
	{
		...
		btn_top.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btnrandom,0,0,0);
		btn_fav.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btnfavorite,0,0,0);
		btn_download.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btndownload,0,0,0);
		btn_up.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btnuploadimage,0,0,0);
		btnsortid.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btndanhsach, 0, 0, 0);
		btnsortnew.setCompoundDrawablesWithIntrinsicBounds(R.drawable.moibtn, 0, 0, 0);
		btnsortrand.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btnrandom, 0, 0, 0);
	...
	public void revertButton(int activ)
	{
		...
		if(activ==3)
		{
			btn_top.setCompoundDrawablesWithIntrinsicBounds(R.drawable.random_highlight,0,0,0);
			btn_top.setTextColor(Color.RED);
		}
		
		if(activ==4)
		{
			btn_fav.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btn_hotactiv,0,0,0);
			btn_fav.setTextColor(Color.RED);
		}
		if(activ==5)
		{
			btn_download.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btndownactiv,0,0,0);
			btn_download.setTextColor(Color.RED);
		}
		if(activ==6)
		{
			btn_up.setCompoundDrawablesWithIntrinsicBounds(R.drawable.btnuploadactiv,0,0,0);
			btn_up.setTextColor(Color.RED);
		}
		if(activ==7)
		{
			btnsortnew.setTextColor(Color.RED);
			btnsortnew.setCompoundDrawablesWithIntrinsicBounds(R.drawable.moiactive, 0, 0, 0);
		}
		if(activ==8)
		{
			btnsortid.setTextColor(Color.RED);
			btnsortid.setCompoundDrawablesWithIntrinsicBounds(R.drawable.danhsach_icon_highlight, 0, 0, 0);
		}
		if(activ==9)
		{
			btnsortrand.setTextColor(Color.RED);
			btnsortrand.setCompoundDrawablesWithIntrinsicBounds(R.drawable.random_highlight, 0, 0, 0);
		}
	}
