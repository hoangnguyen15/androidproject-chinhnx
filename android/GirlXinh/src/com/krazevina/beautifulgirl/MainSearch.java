...
public class MainSearch extends Activity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        if(sql.getfollow(Global.userSearch))
			...
			btn_search.setBackgroundResource(R.drawable.followbtn);
        revertButton(1);
        sql.close();
    }
	...
	public void revertButton(int activ)
	{
		...
		btn_top.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.topbtn,0,0);
		...
		if(activ==3)
		{
			btn_top.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.topactive,0,0);
